...
akl_hourly <- akl_hourly  %>% 
  mutate(
    ...
    datetime = parse_date_time(datetime_string, order = "ymd_HMS")
  )
...
#R versions have historically been released most in April, June, October and December, 1998 saw 10 releases and
#about 75% of releases happen in the morning (at least according to UTC)
